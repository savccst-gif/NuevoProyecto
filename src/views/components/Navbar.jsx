      ...
      <div className="bg-blue-800 text-white text-[10px] sm:text-xs py-1.5 px-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-2.5 sm:gap-4">
            <span className="flex items-center gap-1"><Phone size={10} /> Mesa de ayuda: 600 370 2000</span>
            <span className="flex items-center gap-1"><Globe size={10} /> registrocivil.cl</span>
          </div>
